...
#stem(after)
library('aplpack')
stem.leaf.backback(before,after)#use package aplpack
...
The no of blocked intrusion attempts have significantly reduced after the new firewall
The mean no of  blocked intrusion attempts 
...
After removing the outliers we can see that the spread of data has decreased
